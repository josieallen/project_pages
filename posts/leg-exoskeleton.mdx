...
alt: Poster
tags: embedded-systems, c-languages
---
***Tech Stack:*** Arduino, Arduino IDE, C++. 

### Description: 
Senior Capstone Project. Create a proof of concept to validate the usage of linear actuators as a propulsion mechanism for future soft-suit exoskeleton prototype.

### Skills Learned: 

C++ | Arduino Uno | Embedded Systems | Team Collaboration | Presentations
