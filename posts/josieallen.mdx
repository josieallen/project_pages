...
#### Tech Stack: Vercel, Next.js, HTML, Tailwindcss, Visual Studio Code 
...
Each project has its own page and the front matter is used to make cards for the index page. 
The rest of the mdx page is the content for each page. 
...
Then copying that token and putting it in a `.env` file like `GITHUB_TOKEN=your_token`. 
