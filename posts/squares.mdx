...
Right now I don't have too much going on in my `tailwind.config` so I am not too worried about 
it being too full. If it does get a bit messy I will take out the animation portion. 
